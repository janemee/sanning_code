...
@Controller
@RequestMapping(BaseController.BASE_URI+"/equipmentLog")
public class EquipmentLogController extends BaseController {
    ...
    public ModelAndView list() {
        ...
        modelAndView.setViewName("equipmentLog/list");
        return modelAndView;
    }
    ...
    public ModelAndView add() {
        ...
        modelAndView.setViewName("equipmentLog/add");
        return modelAndView;
    }
    ...
    public ModelAndView update(Integer ids) {
        ...
        modelAndView.addObject("usersList", usersList);
        modelAndView.addObject("equipment", equipment);
        modelAndView.setViewName("equipmentLog/update");
        return modelAndView;
    }
    ...
    public ModelAndView batch(String ids) {
        ...
        modelAndView.setViewName("equipmentLog/batch");
        return modelAndView;
    }
    ...
    public ModelAndView task(String ids) {
        ...
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.addObject("ids", ids);
        modelAndView.setViewName("equipmentLog/eqTask");
        return modelAndView;
    }
}
